...
@property  NSTimer *minShowTimer;
@property  NSDate *showStarted;
...
- (void)setNumberProgress:(NSNumber *)newProgress {
    [self setProgress:[newProgress floatValue]];
}
...
- (void)setNumberProgress:(NSNumber *)progress {
